...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ask("身長を入力してください(m)：")];
                case 1:
                    height = _a.sent();
                    return [4 /*yield*/, ask("体重を入力してください(kg)：")];
                case 2:
                    weight = _a.sent();
                    bmi = (Math.round(10 * (Number(weight) / (Math.pow(Number(height), 2))))) / 10;
                    console.log("\u3042\u306A\u305F\u306EBMI\u306F ".concat(bmi, " \u3067\u3059\u3002\n"));
                    if (bmi < 18.5) {
                        console.log("低体重です");
                    }
